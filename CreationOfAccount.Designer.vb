...
Partial Class CreationOfAccount
    ...
    Private Sub InitializeComponent()
        ...
        ' Guna2ShadowForm1
        ' 
        Guna2ShadowForm1.ShadowColor = Color.Transparent
        ...
        Guna2HtmlLabel4.Text = "Already have an account?"
        ' 
        ' Guna2HtmlLabel3
        ' 
        ...
        Guna2HtmlLabel3.Text = "Register your account"
        ' 
        ' Guna2HtmlLabel2
        ' 
