...
Partial Class FLS2
    ...
    Private Sub InitializeComponent()
        ...
        Guna2HtmlLabel5.Text = "E. Monthly Goal"
        ' 
        ' Guna2Button4
        ' 
        ...
        Guna2HtmlLabel4.Text = "D. Weekly Goal"
        ' 
        ' Guna2HtmlLabel3
        ' 
        ...
        Guna2HtmlLabel3.Text = "Let’s get started" & vbCrLf
        ' 
        ' Guna2HtmlLabel2
        ' 
        ...
        Guna2HtmlLabel2.Text = "Fitness and LifeStyle"
        ' 
        ' Guna2HtmlLabel1
        ' 
